...
- Name: system-tests\auth.spec.ts >> Module 1: Đăng nhập & Bảo mật (Auth & Security) >> TC_LOG_012: Bảo mật - Chống tấn công Cross-Site Scripting (XSS)
- Location: tests\system-tests\auth.spec.ts:71:7
...
- paragraph:
  ...
  - link "Chưa có tài khoản?":
    - /url: /signup
- text: Email
- textbox "admin@clinicserenity.vn": <script>window.location='http://hack.com'</script>@gmail.com
- text: Mật khẩu
- link "Quên mật khẩu?":
  - /url: "#"
- textbox "••••••••": "123456"
