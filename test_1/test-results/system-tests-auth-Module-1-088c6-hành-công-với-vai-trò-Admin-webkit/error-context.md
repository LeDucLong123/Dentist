...
- Name: system-tests\auth.spec.ts >> Module 1: Đăng nhập & Bảo mật (Auth & Security) >> TC_LOG_001: Đăng nhập thành công với vai trò Admin
- Location: tests\system-tests\auth.spec.ts:10:7
