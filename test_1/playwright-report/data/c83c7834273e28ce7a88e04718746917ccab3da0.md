...
- Name: system-tests\auth.spec.ts >> Module 1: Đăng nhập & Bảo mật (Auth & Security) >> TC_LOG_003: Đăng nhập thành công với vai trò Lễ tân
- Location: tests\system-tests\auth.spec.ts:34:7
