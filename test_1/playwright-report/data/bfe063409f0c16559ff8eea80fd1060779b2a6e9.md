...
- Name: system-tests\auth.spec.ts >> Module 1: Đăng nhập & Bảo mật (Auth & Security) >> TC_LOG_011: Bảo mật - Chống tấn công SQL Injection
- Location: tests\system-tests\auth.spec.ts:62:7
...
- paragraph:
  ...
  - link "Chưa có tài khoản?":
    - /url: /signup
- text: Email
- textbox "admin@clinicserenity.vn": "' OR '1'='1' --"
- text: Mật khẩu
- link "Quên mật khẩu?":
  - /url: "#"
- textbox "••••••••": "' OR '1'='1'"
