...
- Name: system-tests\auth.spec.ts >> Module 1: Đăng nhập & Bảo mật (Auth & Security) >> TC_LOG_018: Phân quyền nghiêm ngặt - Chặn truy cập trái phép bằng URL
- Location: tests\system-tests\auth.spec.ts:81:7
