...
- Name: system-tests\admin-management.spec.ts >> Module 3: Quản trị & Nghiệp vụ nội bộ (Admin Management & Payroll) >> TC_MGMT_003: Admin chốt bảng lương - Đóng băng dữ liệu (Read-only after Freeze)
- Location: tests\system-tests\admin-management.spec.ts:95:7
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    31 × unexpected value "http://localhost:3000/login"
